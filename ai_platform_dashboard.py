...
with tab1:
    ...
    creator_counts.columns = ['Creator', 'Model Count']
    fig = px.bar(creator_counts, x='Creator', y='Model Count',
                 labels={'Creator': 'Creator', 'Model Count': 'Number of Models'},
                 title="Models per Creator")
